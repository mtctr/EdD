...
public class VertexCover {
	...
	/**
	 * Check whether the vertex cover is valid (covering all edges) The time
	 * complexity should is O(E)
	 */
	...
	/**
	 * Compute a vertex cover with Gavril's algorithm It computes a set of edges
	 * defining a maximal matching: the incident vertices provide the vertex
	 * cover.
	 */
	...
	/**
	 * Return a String with the labels of vertices, listed according to a DFS
	 * traversal Iterative version
	 */
	...
	/**
	 * Compute a vertex cover with Savage's algorithm The cover is defined by
	 * the inner nodes of the DFS spanning tree (leaves are omitted) The graph
	...
	// -----------------------------------------------------
	// ----------- functions below deal with tests ---------
	// -----------------------------------------------------
